...
public class SwmodelingexamplePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Swmodelingexample";
	...
	private SwmodelingexamplePersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(com.autoinsurance.Customer.class);
		configuration.addAnnotatedClass(com.autoinsurance.Vehicle.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new SwmodelingexamplePersistentManager();
		}
